...
public class TmpCartera implements java.io.Serializable
{
   ...
   public Date getFAsiganado() { return fAsiganado; }

   public void setFAsiganado(Date fAsiganado)
   {
      this.fAsiganado = fAsiganado;
   }
}
