...
function createform(form) {
    if (autorizar("agregar")) {
    	...
    	var bean = new Packages.com.metropolitana.multipagos.AvonPagos();
	    var handlerBean = new Packages.com.metropolitana.multipagos.forms.avon_pagos.AvonPagosHandler();
