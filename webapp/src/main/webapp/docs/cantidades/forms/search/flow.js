...
function searchform(form) {
    if (autorizar("cata")) {
        ...
        cocoon.sendPage("cantidades.list?cantidadNombre="+cantidadNombre+"&filtrar="+filtrar+"&pagina=1");
...
function cantidadesList() {
    ...
    var bean = handler.getResultadosXPagina(cantidadNombre, filtrar, pagina, cocoon.session.registrosPorPagina);
