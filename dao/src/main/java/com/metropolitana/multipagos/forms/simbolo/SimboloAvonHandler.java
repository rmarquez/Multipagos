...
import com.metropolitana.multipagos.SimboloAvon;
 ...
 */
public class SimboloAvonHandler {
	 ...
	 */
	public static SimboloAvon retrieve(final Integer simboloId,
			final PersistenceBroker broker) {
		SimboloAvon criterio = new SimboloAvon();
		criterio.setSimboloId(simboloId);
		Query query = new QueryByIdentity(criterio);
		return (SimboloAvon) broker.getObjectByQuery(query);
	}
	 ...
	 * @return bean que contiene los datos del simbolo
	 */
	public static SimboloAvon retrieve(final Integer simboloId) throws Exception {
	...
	private Collection getList(final Criteria criterio) throws Exception {
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			QueryByCriteria query = new QueryByCriteria(SimboloAvon.class, criterio);
	...
	public final Collection<SimboloAvon> getResultadosXPagina(
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			return Util.getResultadosXPagina(SimboloAvon.class,
	...
	public final int getContador(final String simboloNombre, final Integer filtrar)
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			QueryByCriteria query = new QueryByCriteria(SimboloAvon.class,
					Util.getCriterio(simboloNombre, filtrar, CAMPO_BUSQUEDA));
	...
	public static SimboloAvon simboloXNumero(final Integer simboloNumero)
			throws Exception {
		PersistenceBroker broker = null;
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
