 ...
 */
public class SimboloBanproHandler {
	 ...
	 */
	public static SimboloBanpro retrieve(final Integer simboloId,
			final PersistenceBroker broker) {
		SimboloBanpro criterio = new SimboloBanpro();
		criterio.setSimboloId(simboloId);
		Query query = new QueryByIdentity(criterio);
		return (SimboloBanpro) broker.getObjectByQuery(query);
	}
	 ...
	 * @return bean que contiene los datos del simbolo
	 */
	public static SimboloBanpro retrieve(final Integer simboloId) throws Exception {
	...
	private Collection getList(final Criteria criterio) throws Exception {
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			QueryByCriteria query = new QueryByCriteria(SimboloBanpro.class, criterio);
	...
	public final Collection<SimboloBanpro> getResultadosXPagina(
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			return Util.getResultadosXPagina(SimboloBanpro.class,
	...
	public final int getContador(final String simboloNombre, final Integer filtrar)
		...
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
			QueryByCriteria query = new QueryByCriteria(SimboloBanpro.class,
					Util.getCriterio(simboloNombre, filtrar, CAMPO_BUSQUEDA));
	...
	public static SimboloBanpro simboloXNumero(final Integer simboloNumero)
			throws Exception {
		PersistenceBroker broker = null;
		try {
			broker = PersistenceBrokerFactory.defaultPersistenceBroker();
