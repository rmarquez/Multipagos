/*
 * Archivo: NumeroLetras.java
 * Autor: Tomado de la Web del programador
 * Creado el 05-nov-2003
 *
 */
...
public class NumeroLetras {
	...
	public String convertirLetras(double numero) {
	    	...
	    	int i = d.intValue();
	    	double frac = (numero - i) * 100;
	    	return convertirLetras(i).toUpperCase(Locale.getDefault()) + " CON " + Math.round(frac) + "/100";
		}
}
